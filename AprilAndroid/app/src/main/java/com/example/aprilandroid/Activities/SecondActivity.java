...
import com.example.aprilandroid.Data.DataBaseHelper;
...
public class SecondActivity extends AppCompatActivity {
    ...
    //        insert.setOnClickListener(v -> {
//            boolean isInserted = dataBaseHelper.insertData(444, "Soham", "Kumar", 90, "A");
//            if(isInserted){
...
//                data.append("Surname: " + res.getString(2) + "\n");
//                data.append("Marks: " + res.getString(3) + "\n");
//                data.append("Grade: " + res.getString(4) + "\n");
//            }
//        });

//        update.setOnClickListener(v -> {
//            boolean isUpdated = dataBaseHelper.updateData(444, "Soham", "Kumar", 85, "B");
//            if(isUpdated){
//                Toast.makeText(SecondActivity.this, "Data Updated", Toast.LENGTH_SHORT).show();
//            }else{
//                Toast.makeText(SecondActivity.this, "Data not Updated", Toast.LENGTH_SHORT).show();
//            }
//        });
//
//        delete.setOnClickListener(v -> {
//            dataBaseHelper.deleteData(444);
//        });
