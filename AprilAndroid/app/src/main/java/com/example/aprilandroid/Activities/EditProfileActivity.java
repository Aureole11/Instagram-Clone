...
public class EditProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profileImage = findViewById(R.id.profile_pitcure);
        ...
        if (ImageUri != null){
            ...
            uploadTask.continueWithTask(task -> {
                ...
                if (task.isSuccessful()){
                    ...
                    reference.child("imageUrl").setValue(nUri).addOnCompleteListener(task1 -> {
                        if (task1.isSuccessful()){
                            progressDialog.dismiss();
                            Toast.makeText(EditProfileActivity.this, "Profile pitcure updated", Toast.LENGTH_SHORT).show();
                        }else {
                            progressDialog.dismiss();
                            Toast.makeText(EditProfileActivity.this, "Failed to upload profile pitcure", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
